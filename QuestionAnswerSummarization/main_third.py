...
class Summarizer(object):
    ...
    def decode(self, test_data):
        ...
        for idx in range(len(test_data)):
            ...
            pred, hidden = self.model_dec.forward(sos_embed.unsqueeze(0), context, enc_word, coverage_vec, attention_weights)
...
def train_model_encdec_cov(train_data, test_data, input_indexer, output_indexer, args, device):
    ...
    for epoch in range(0,1):#20
        ...
        for idx in perm0:
            ...
            ind_ques = torch.from_numpy(np.array(train_data[idx].label)).to(device)
...
if __name__ == '__main__':
   ...
   # print(len(answer_exs))
    ...
    evaluate(decoder, answer_exs[1:2])
